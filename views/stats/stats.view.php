          ...
          <div class="pb-3">
            <div class="flex flex-col lg:flex-row lg:justify-between border-[#2e2e2e] px-4 gap-4">
              <div class="flex gap-4 sm:gap-8 overflow-x-auto pb-2 lg:pb-0">
                <a class="flex flex-col items-center justify-center border-b-[3px] border-b-[#c00000] text-[#ffffff] pb-[13px] pt-4 whitespace-nowrap" href="stats">
                  <p class="text-[#ffffff] text-sm font-bold leading-normal tracking-[0.015em]">Published</p>
                </a>
