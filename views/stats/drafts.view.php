          ...
          <div class="pb-3">
            <div class="flex flex-col lg:flex-row lg:justify-between border-[#2e2e2e] px-4 gap-4">
              <div class="flex gap-4 sm:gap-8 overflow-x-auto pb-2 lg:pb-0">
                ...
                <a class="flex flex-col items-center justify-center border-b-[3px] border-b-[#c00000] text-[#ffffff] hover:text-[#ffffff] pb-[13px] pt-4 whitespace-nowrap transition-colors" href="drafts">
              ...
              <table class="w-full min-w-[640px]">
                ...
                <tbody>
                  <tr class="border-t border-[#2e2e2e] hover:bg-[#2e2e2e]/30 transition-colors">
                    <td class="px-4 py-4 text-[#ffffff] text-sm font-normal leading-normal">Untitled Post</td>
                    <td class="px-4 py-4 text-sm font-normal leading-normal">
                      <span class="inline-flex items-center justify-center rounded-lg px-3 py-1 bg-[#FDE047]/20 text-[#FDE047] text-xs font-medium whitespace-nowrap">
                        Draft
                      </span>
                    </td>
                    ...
                    <td class="px-4 py-4 text-[#a3a3a3] text-sm font-bold leading-normal tracking-[0.015em] hidden md:table-cell">
                      <span class="text-[#FDE047] hover:text-[#facc15] cursor-pointer transition-colors">Edit</span> | 
                      <span class="text-[#c00000] hover:text-[#d55454] cursor-pointer transition-colors">Delete</span>
                    </td>
                  </tr>
                  <tr class="border-t border-[#2e2e2e] hover:bg-[#2e2e2e]/30 transition-colors">
                    <td class="px-4 py-4 text-[#ffffff] text-sm font-normal leading-normal">Another Draft</td>
                    <td class="px-4 py-4 text-sm font-normal leading-normal">
                      <span class="inline-flex items-center justify-center rounded-lg px-3 py-1 bg-[#FDE047]/20 text-[#FDE047] text-xs font-medium whitespace-nowrap">
                        Draft
                      </span>
