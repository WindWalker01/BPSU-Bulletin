<div class="min-h-screen">
  <div class="w-10xl max-w-[80%] mx-auto md:px-0 pt-8 sm:pt-12 md:pt-16">
    ...
    <div class="mt-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold">University Organizations</h1>
        <p class="text-base sm:text-lg text-text-secondary mt-1">Explore student clubs and organizations you can join.</p>
    </div>
