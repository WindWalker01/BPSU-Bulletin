  ...
  <div class="w-10xl max-w-[80%] mx-auto md:px-0 pt-8 sm:pt-12 md:pt-16">
    ...
    <div id="achievementsContainer" class="mt-8 space-y-4">
        <?php foreach ($blogs as $b): ?>
            ...
            <a href="/blog?id=<?= $b['id'] ?>" class="block achievements-card border-2 rounded-2xl" data-date="<?= htmlspecialchars($b['created_at']) ?>"> 
...
<script>
  ...
  select.addEventListener('change', () => {
    const cards = Array.from(container.querySelectorAll('.achievements-card'));
