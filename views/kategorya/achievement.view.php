...
<h1 class="text-4xl text-white absolute inset-x-60 inset-y-50 font-bold">University Achievements</h1>
    <p class="text-sm text-white/50 absolute inset-x-62 inset-y-65">All Students and Faculty Achievements</p>
