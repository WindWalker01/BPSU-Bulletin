...
$isProfileLocked = isset($prefs["show_profile_public"]) && $prefs["show_profile_public"] == 1;
...
$blogs = array_map(function($blog) use ($categoryColorMap) {
    ...
    $colorClass = $categoryColorMap[$blog['category_label']] ?? 'bg-gray-500/20 text-gray-400';
